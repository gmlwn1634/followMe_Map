...
public class BeaconData {
    ...
    // 칼만필터 값
    private double Q = 0.000005;
    private double R = 0.001;
    private double P = 1, K;

    BeaconData(String argMajor, String argMinor, double argLat, double argLng) {
        major = argMajor;
        minor = argMinor;
        lat_wgs84 = argLat;
        lng_wgs84 = argLng;
    ...
    void setMinor(String argMinor) {
        this.minor = argMinor;
    }

    void setLat_wgs84(double argLat) {
        this.lat_TM = argLat;
    }

    void setLng_wgs84(double argLng) {
        this.lng_TM = argLng;
    }

    void setLat_TM(double argLat) {
        this.lat_TM = argLat;
    }

    ;

    void setLng_TM(double argLng) {
        this.lng_TM = argLng;
    }

    ;

    void setK_RSSI(double argK_RSSI) {
        this.K_RSSI = argK_RSSI;
    }

    void setdistance(double argDistance) {
