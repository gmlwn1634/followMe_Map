...
public class BeaconList {
    ...
    public double getFloor() {return this.floor;}

    public void setLat(double argLat) { this.lat = argLat;}
    public void setLng(double argLng) { this.lng = argLng;}
    public void setFloor(int argFloor) {this.floor = argFloor;};
